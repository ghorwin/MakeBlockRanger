...
Der _MakeBlock Ranger_ Bausatz verwendet ein _Auriga Board_ mit einem _Arduino Mega 2560_ Prozessor. Das Auriga-Board ist die Weiterentwicklung des Orion-Boards (welches bei früheren mBot Bausätzen verwendet wurde) und kann einiges mehr.
