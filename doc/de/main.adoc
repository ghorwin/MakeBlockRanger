...
Es geht also um folgenden Roboter
...
- Unterstützt Bluetooth-Steuerung sowie drahtlose Firmware-Updates über Bluetooth
- Blaue LED
- WS2812 RGB-LED-Ring (12 LEDs)
- USB-Anschluss mit antistatischem Schutz (Akkus werden darüber nicht geladen)
- RJ25-Ports/Anschlüsse für externe Hardware
...
Details zu den RJ25 Ports gibt es im <<chap:rj25>>.


### Informationsquellen

Die offizielle Dokumentation des Roboterbausatzes schweigt sich über die Interna und die Programmierung der Platine ziemlich aus. Daher basiert diese Anleitung auf Reverse-Engineering, Literaturrecherche im Internet und Sichtung vieler Forenbeiträge.

Viele nachfolgend und in den anderen Teilen beschriebene Details habe ich dem englischsprachigen Text von _Gosse Adema_ (https://www.instructables.com/Advanced-Makeblock-Sensors-DIY[https://www.instructables.com/Advanced-Makeblock-Sensors-DIY]) entnommen.
...
// chapter 8
include::makeblock-ranger-RJ25.adoc[leveloffset=+1]
