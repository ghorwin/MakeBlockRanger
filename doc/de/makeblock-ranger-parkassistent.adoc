...
- der Raider fährt erstmal an den parkenden Autos/Hindernissen vorbei und misst den Abstand ->  der sollte eigentlich immer gleich bleiben, sonst steht der Raider schief
...
- und sobald die Lücke zu Ende ist, wird geprüft, ob sie lang genug ist (wieder mit Licht + Sound Feedback)
