...
Vielleicht abschließend noch ein paar kurze Infos über mich. Mein Name ist Andreas Nicolai (ursprünglich aus Berlin, aber jetzt schon seit vielen Jahren in Dresden) und ich bin in einer Zeit groß geworden, als Computer noch recht primitiv waren (mein erster Rechner war ein Commodore PC-10 III  mit gerade mal 4,77...9,54 MHz Taktfrequenz). Entsprechend einfach war die Software (und entsprechend simpel waren die Spiele). Aber so konnte ich die Entwicklung der Hardware und Software über inzwischen 4 Jahrzehnte mitverfolgen.
